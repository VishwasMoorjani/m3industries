                                            ...
                                            <div class="contact-form form-style">
                                                <div class="row">
                                                    <div class="col-lg-6 col-md-12 col-12">
                                                        ...
                                                        <input type="text" placeholder="" id="fname4" name="fname">
                                                    </div>
                                                    <div class="col-lg-6 col-md-12 col-12">
                                                        <label for="fname3">Last Name</label>
                                                        <input type="text" placeholder="" id="fname3" name="fname">
                                                    </div>
                                                    <div class="col-lg-6 col-md-12 col-12">
                                                    ...
                                                    <div class="col-lg-6 col-md-12 col-12">
                                                        ...
                                                        <input type="text" placeholder="" id="City2" name="City">
                                                    </div>
                                                    <div class="col-lg-12 col-md-12 col-12">
                                                        <label for="Adress2">Address</label>
                                                        <input type="text" placeholder="" id="Adress2" name="Adress">
                                                    </div>
                                                    <div class="col-lg-6 col-md-12 col-12">
                                                    ...
                                                    <div class="col-lg-6 col-md-12 col-12">
                                                        ...
                                                        <input type="text" placeholder="" id="emails" name="email">
                                                    </div>
                                                    <div class="col-lg-12 col-md-12 col-12">
                                                        <label for="emaild">Phone No.</label>
                                                        <input type="text" placeholder="" id="emaild" name="email">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div id="open5" class="payment-name active">
                                                <ul>
                                                    <li class="visa"><input id="1" type="radio" name="size" value="30">
                                                        <label for="1"><img
                                                                src="<?=base_url('assets/front/images/checkout/img-1.png');?>"
                                                                alt=""></label>
                                                    </li>
                                                    <li class="mas"><input id="2" type="radio" name="size" value="30">
                                                        <label for="2"><img
                                                                src="<?=base_url('assets/front/images/checkout/img-2.png');?>"
                                                                alt=""></label>
                                                    </li>
                                                    <li class="ski"><input id="3" type="radio" name="size" value="30">
                                                        <label for="3"><img
                                                                src="<?=base_url('assets/front/images/checkout/img-3.png');?>"
                                                                alt=""></label>
                                                    </li>
                                                    <li class="pay"><input id="4" type="radio" name="size" value="30">
                                                        <label for="4"><img
                                                                src="<?=base_url('assets/front/images/checkout/img-4.png');?>"
                                                                alt=""></label>
                                                    </li>
                                                </ul>
                                                <div class="contact-form form-style">
                    ...
                    <div class="col-lg-4 col-12">
                        <div class="cout-order-area">
                            <div class="oreder-item">
                                <ul>
                                    <li class="o-header">Your Order<span>(4)</span></li>
