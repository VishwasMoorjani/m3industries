          ...
          <div class="d-lg-flex">
            ...
            <div class="ms-auto my-auto mt-lg-0 mt-4">
              <div class="ms-auto my-auto">
                <a href="addchildcategory" class="btn bg-gradient-primary btn-sm mb-0">+&nbsp; New Child-Category</a>
        ...
        <div class="card-body px-0 pb-0">
          <div class="table-responsive">
            <table class="table table-flush" id="products-list">
              <thead>
                <tr>
                  <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Child-Category</th>
                  <th class="text-uppercase text-secondary text-xxs text-center font-weight-bolder opacity-7">Child-Category Code</th>
              ...
              <tbody>
                <?php foreach ($categories as $category) { ?>
                  <tr>
                    ...
                    <td class="align-middle text-center">
                      <span class="text-secondary text-xs font-weight-bold"><?=($category['main']); ?></span>
                    </td>
                    <td class="align-middle">
                      <a href="<?=base_url('admin/editchildcategory/'. $category['link']); ?>" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit category">
