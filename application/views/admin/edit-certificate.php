    ...
    <div class="card">
        <div class="card-header p-0 position-relative mt-n5 mx-3 z-index-2">
            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                <center>
                    <h5 class="font-weight-bolder text-white">Certificate Information</h5>
                </center>
            </div>
        </div>
        <div class="card-body">

            <form class="multisteps-form__form" method="post" action="editcertificate" enctype="multipart/form-data">
                    ...
                    <div class="multisteps-form__content">
                        <div class="row mt-3">
                            <div class="col-12 col-sm-6">
                                <input type="hidden" name="link" value="<?=$certificate['link']; ?>">
                                ...
                                <?php } else { ?>
                                    ...
                                    <span>Recommended Size: 213*320px</span>
                                <?php } ?>
                                <?php
...
<script>
    ...
    function removeimg() {
        <?php $link = $certificate['link'];  ?>
        $.ajax({
            url: "removecertificate/<?= $link ?>", //the page containing php script
