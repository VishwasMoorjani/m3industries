          ...
          <div class="d-lg-flex">
            ...
            <div class="ms-auto my-auto mt-lg-0 mt-4">
              <div class="ms-auto my-auto">
                <a href="addcategory" class="btn bg-gradient-primary btn-sm mb-0">+&nbsp; New Category</a>
                ...
                <?php foreach ($categories as $category) { ?>
                  <tr>
                    ...
                    <td class="align-middle">
                      <a href="<?=base_url('admin/editcategory/'. $category['link']); ?>" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit category">
