...
<div class="container-fluid py-4 mt-5">
    <div class="card">
        ...
        <div class="card-body">
            <form class="multisteps-form__form" method="post" action="addshow" enctype="multipart/form-data">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="input-group input-group-static m-2">
                                    ...
                                    <input class="form-control" type="text" name="date" id="date" value="<?=set_value('date'); ?>" required>
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="input-group input-group-static m-2">
                                    ...
                                    <input class="form-control" type="text" name="venue" id="venue" value="<?=set_value('venue'); ?>" required>
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="input-group input-group-static m-2">
                                    ...
                                    <input class="form-control" type="text" name="booth" id="booth" value="<?=set_value('booth'); ?>" required>
