          ...
          <div class="d-lg-flex">
            ...
            <!-- <div class="ms-auto my-auto mt-lg-0 mt-4">
              <div class="ms-auto my-auto">
                <a href="addsliders/slider" class="btn bg-gradient-primary btn-sm mb-0">+&nbsp; New Slider</a>
              </div>
            </div> -->
          </div>
        </div>
                  ...
                  <tr>
                    <td>
                      <div class="d-flex px-2 py-1">
                        <div>
                          <img src="<?=base_url('assets/front/images/' . $slider['image']) ?>" class="w-80 border-radius-lg" alt="user1">
                        </div>
                    ...
                    <td>
                      <p class="text-xs font-weight-bold mb-0"><?=$slider['url']; ?></p>
                    </td>
