    ...
    <div class="col-12">
      <div class="card">
        ...
        <div class="card-header pb-0">
          <div class="d-lg-flex">
            <div>
              <h5 class="mb-0">Abandoned Cart</h5>
            </div>
                ...
                <?php $i = 1; foreach ($orders as $order) { ?>
                  <tr>
                    ...
                    <td class="align-middle">
                      <a href="<?=base_url('admin/abandoneddetails/'. $order['order_id']); ?>" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
