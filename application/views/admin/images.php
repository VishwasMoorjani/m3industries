...
<div class="container-fluid py-4 mt-5">
    <div class="card">
        ...
        <div class="card-body">
            <form action="<?=base_url('admin/dragDropUpload/'.$link); ?>" class="dropzone">
            </form>
            <div class="row" >
                <?php
            if (!empty($images)) {
                foreach ($images as $row) {
                    $filePath = base_url('assets/front/images/'. $row);
            ?>
            <div class="col-lg-2 col-md-3 m-2">
                 <img src="<?=base_url('assets/front/images/'. $row); ?>" width="150px" height="140px" />
                 <hr>
                    <a class="btn btn-primary" href="removeimage/<?=$link."/".$row; ?>" role="button">Remove Image</a>
            </div>
