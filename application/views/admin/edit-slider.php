                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                <div class="input-group input-group-static m-2">
                                    ...
                                    <input class=" form-control" type="text" name="heading" id="heading" value="<?=$slider['heading']; ?>" required>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                <div class="input-group input-group-static m-2">
                                    ...
                                    <input class=" form-control" type="text" name="description" id="description" value="<?=$slider['description']; ?>" required>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                <div class="input-group input-group-static m-2">
                                    ...
                                    <input class=" form-control" type="text" name="url" id="link" value="<?=$slider['url']; ?>" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
